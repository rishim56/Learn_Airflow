...
PROJECT_ID='sylvan-plane-408707' #project name
PYSPARK_URI='gs://spark-code-dag-test/sparkcode.py' # spark job location in cloud storage
...
with models.DAG(
    ...
    gsc_to_gbq = GCSToBigQueryOperator(
        ...
        bucket="spark-code-dag-test",
        source_objects =["target/*.snappy.parquet"],
        destination_project_dataset_table ="sylvan-plane-408707.dataset_first.spark_data", # bigquery table
